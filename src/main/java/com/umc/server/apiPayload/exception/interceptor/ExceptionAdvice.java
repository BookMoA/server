...
public class ExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleExceptionInternal(
        ...
        ApiResponse<Object> body =
                ApiResponse.onFailure(reason.getCode(), reason.getDescription(), null);
        //        e.printStackTrace();
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(
        ...
        ApiResponse<Object> body =
                ApiResponse.onFailure(
                        ...
                        errorCommonStatus.getDescription(),
                        errorPoint);
    ...
    private ResponseEntity<Object> handleExceptionInternalArgs(
        ...
        ApiResponse<Object> body =
                ApiResponse.onFailure(
                        errorCommonStatus.getCode(), errorCommonStatus.getDescription(), errorArgs);
    ...
    private ResponseEntity<Object> handleExceptionInternalConstraint(
        ...
        ApiResponse<Object> body =
                ApiResponse.onFailure(
                        errorCommonStatus.getCode(), errorCommonStatus.getDescription(), null);
        return super.handleExceptionInternal(
                e, body, headers, errorCommonStatus.getHttpStatus(), request);
    }
}
